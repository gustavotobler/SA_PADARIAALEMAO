...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($acao === "pagar") {
        ...
        // Inserir itens na tabela de pagamentos
...
<form method="post"><input type="hidden" name="acao" value="nova"><button class="btn green">Nova Comanda</button></form>
...
<form method="post" style="display:inline-block;"><input type="hidden" name="acao" value="fechar"><input type="hidden" name="id_venda" value="<?=$comandaSel['ID_vendas']?>"><button class="btn green">Fechar Comanda</button></form>
<form method="post" style="display:inline-block;"><input type="hidden" name="acao" value="cancelar"><input type="hidden" name="id_venda" value="<?=$comandaSel['ID_vendas']?>"><button class="btn red">Cancelar</button></form>
<form method="post" style="display:inline-block;"><input type="hidden" name="acao" value="salvar"><input type="hidden" name="id_venda" value="<?=$comandaSel['ID_vendas']?>"><button class="btn blue">Salvar Comanda</button></form>

<!-- Botão ir para pagamento -->
<form method="post" style="display:inline-block;"><input type="hidden" name="acao" value="pagar"><input type="hidden" name="id_venda" value="<?=$comandaSel['ID_vendas']?>"><button class="btn green">Confirmar Pagamento</button></form>
</div>
<?php endif; ?>
