...
// Verifica se o usuário está logado e tem nível de administrador
...
// Só continua se o formulário foi enviado via POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Função para transformar datas do formato dd/mm/yyyy para yyyy-mm-dd
    ...
    // Prepara a query para inserir o funcionário no banco
